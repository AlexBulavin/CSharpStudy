...
double X = Convert.ToDouble(Console.ReadLine()); //Читаем и преобразуем строку в int
Console.Write("\nВведите Y: "); //Запрашиваем у пользователя 2 число. Проверку не производим (пока)
double Y = Convert.ToDouble(Console.ReadLine()); //Читаем и преобразуем строку в int
